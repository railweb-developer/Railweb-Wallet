...
export const AppIntroView: React.FC<Props> = ({ onComplete }) => {
  ...
  const getTextForStage = (stage: number) => {
    switch (stage) {
      case 0:
        return 'Welcome to Rail Web. The private DeFi wallet.';
      case 1:
      ...
      case 2:
        return 'Rail Web Wallet takes privacy and anonymity seriously. This app exists solely on your device and does not store any data on centralized servers. It does not collect or send any analytics. You are in complete control and maintain sole responsibility of your data and funds at all times.';
    }
